# Generated by Django 2.1.5 on 2019-02-20 01:28
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('data_type', models.CharField(choices=[('txt', 'TEXT'), ('aml', 'ARCHIEML'), ('img', 'IMAGE'), ('mdn', 'MARKDOWN'), ('xls', 'SPREADSHEET')], default='text', max_length=3)),
